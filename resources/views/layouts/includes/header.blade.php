...
<head>
  ...
  <link href="{{asset('app-assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
  ...
  <link href="{{asset('app-assets/css/custom-styles.css')}}" rel="stylesheet">
