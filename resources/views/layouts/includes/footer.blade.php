<footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Sri lanka <br><br>
              <strong>Phone:</strong>077 777 1498<br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Thineth</span></strong>. All Rights Reserved
        </div>
        <div class="credits">

          Designed by Thulana Vinnath 2021 A/L Batch</a>
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="https://m.facebook.com/#!/sandaruwanpereraaccounting/?tsid=0.9071222888340857&source=result" target="_blank"  class="facebook"><i class="bx bxl-facebook"></i></a>
  ...
  <script src="{{asset('app-assets/vendor/counterup/counterup.min.js')}}"></script>
  ...
  <script src="{{asset('app-assets/js/custom-js.js')}}"></script>